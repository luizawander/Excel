...
if vinculo_col is None or nome_col is None or status_col is None:
    raise ValueError("Coluna 'Vínculo', 'nome' ou 'Status Contratação' não encontrada.")
...
for row in range(2, ws.max_row + 1):  
    ...
    if status_value != 'INATIVO':
        if vinculo_value is None or vinculo_value == '#N/D':
            ...
            print(f'Linha {row}: Nome = {nome_value}')